<?php $__env->startSection('content'); ?>
    ...
    <div class="center-wrapper">
        <div class="logo-bar">
            <img src="<?php echo e(asset('images/um.png')); ?>" alt="UM Logo">
        </div>
    ...
    <div class="logo">
        ...
        <img src="<?php echo e(asset('images/logo-positron.png')); ?>" alt="Logo POSITRON" style="width: 300px; position: center; margin-right: 27px; margin-bottom: 40px; margin-left: 256px;">
...
<section id="sambutan" class="section-locker" style="background: url('/images/long-locker.png') no-repeat center center; background-size: cover; width: auto; min-height: 100vh;">
    <div class="locker-overlay">
        ...
        <img src="<?php echo e(asset('images/logo-positron-rodokburem.png')); ?>" alt="Locker Sambutan" class="locker-bg">
    ...
    <div id="videoCarousel" class="carousel slide" data-bs-ride="carousel">
       <div class="carousel-inner">
            <?php $__currentLoopData = [
                ...
                'https://www.youtube.com/embed/dQw4w9WgXcQ',
                'https://www.youtube.com/embed/dQw4w9WgXcQ',
            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="carousel-item <?php echo e($i === 0 ? 'active' : ''); ?>">
                <div class="d-flex justify-content-center">
                    <div class="video-wrapper">
                    <iframe
                        src="<?php echo e($link); ?>"
                        title="Video <?php echo e($i + 1); ?>"
                        frameborder="0"
                        allowfullscreen
        ...
        <div class="container">
            ...
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
                <?php $__currentLoopData = [
                        ...
                        ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nama => $icon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col">
                        <div class="flip-card">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Downloads\web-positron-main\web-positron-main\resources\views/beranda.blade.php ENDPATH**/ ?>