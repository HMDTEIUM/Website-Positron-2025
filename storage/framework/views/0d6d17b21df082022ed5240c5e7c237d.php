    ...
    <section class="bg-white min-vh-100 py-5 pt-md-5 pt-4">
        <div class="container animate__animated animate__fadeIn">
            ...
            <div class="d-flex justify-content-center mb-4">
                <form action="<?php echo e(route('group.search')); ?>" method="GET" class="w-100" style="max-width: 700px;"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Downloads\web-positron-main\web-positron-main\resources\views/group.blade.php ENDPATH**/ ?>