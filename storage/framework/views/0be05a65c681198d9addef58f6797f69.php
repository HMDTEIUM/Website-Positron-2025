...
<head>
  ...
  <style>
    ...
    @font-face {
      ...
      src: url('<?php echo e(asset('fonts/ScribbleMarker.otf')); ?>') format('opentype');
      font-weight: normal;
      font-style: normal;
    }
...
<body>
  ...
  <footer class="text-center">
    <div class="container">
      <p class="mb-1">© <?php echo e(date('Y')); ?> POSITRON 2025</p>
...
<?php /**PATH C:\Users\USER\Downloads\web-positron-main\web-positron-main\resources\views/layouts/app.blade.php ENDPATH**/ ?>