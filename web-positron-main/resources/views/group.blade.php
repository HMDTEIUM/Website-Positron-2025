...
<section class="search-section min-vh-100 py-5 mt-5">
    <div class="container animate__animated animate__fadeIn">
        ...
        <div class="d-flex justify-content-center mb-4 gap-3 flex-wrap">
            <button type="button" class="filter-btn btn btn-outline-light rounded-pill px-4 py-2 active"
                data-filter="nama">Nama</button>
            <button type="button" class="filter-btn btn btn-outline-light rounded-pill px-4 py-2"
        ...
        <div id="loadingSpinner" class="text-center mt-4 d-none">
            ...
            <p class="text-light mt-2 fs-6">Sedang mencari data...</p>
        </div>

        <!-- Teks Petunjuk -->
        <p class="text-center text-light fst-italic mt-4 fs-6">
...
/* Make placeholder text more visible on dark bg */
